...
TEST_CASE("BSpline", "[nonrational][bspline]")
{
    ...
    {
        BSpline<Scalar, 3, -1> curve;
        Eigen::Matrix<Scalar, Eigen::Dynamic, 3> ctrl_pts(19, 3);
        ctrl_pts << -10.0, 15.5310576336456, 18.1944850826781, -10.0, 15.4942915438814,
            18.0069923423818, -10.0, 15.5299511372992, 17.818720790930502, -10.0, 15.635358246476,
            17.657588928408, -10.0, 15.795458702205899, 17.5484585550519, -10.0, 15.985874692647398,
            17.5092391143418, -10.0, 16.176934948279502, 17.5465350702587, -10.0, 16.3388576428594,
            17.6547001524155, -10.0, 16.446439582892403, 17.8168817146045, -10.0,
            16.483127779568502, 18.0077182680554, -10.0, 16.443658120277203, 18.1975322242385,
            -10.0, 16.33467769273, 18.3571967915823, -10.0, 16.173362857168897, 18.4626984195181,
            -10.0, 15.984465085195898, 18.4985959138602, -10.0, 15.7964926401182, 18.4600013958365,
            -10.0, 15.637846449201101, 18.353315982249498, -10.0, 15.5310576336456,
            18.1944850826781, -10.0, 15.4942915438814, 18.0069923423818, -10.0, 15.5299511372992,
            17.818720790930502;
        Eigen::Matrix<Scalar, Eigen::Dynamic, 1> knots(23, 1);
        knots << -0.18590629514882695, -0.12387445986816303, -0.06221757680775297, 0.0,
            0.0617405891715982, 0.124177075640185, 0.186971396624525, 0.249924319934475,
            0.312944397095558, 0.375981787372133, 0.438988611848275, 0.501908430921101,
            0.564681543889078, 0.627268448671589, 0.689671538587703, 0.751931471677711,
            0.814093704851173, 0.876125540131837, 0.937782423192247, 1.0, 1.0617405891715983,
            1.124177075640185, 1.186971396624525;
        curve.set_control_points(ctrl_pts);
        curve.set_knots(knots);
        curve.set_periodic(true);
        curve.initialize();
