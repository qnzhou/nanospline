...
public:
    ...
    static Scalar integrate(FunctionType& func, Scalar t0, Scalar t1)
    {
        throw not_implemented_error("Please specify the number of quadrature points");
    }
};
...
public:
    ...
    static Scalar integrate(FunctionType& func, Scalar t0, Scalar t1)
    {
        ...
        return (val0 * w0 + val1 * w0 + val2 * w1 + val3 * w1) * (t1 - t0) * 0.5;
    }
};
...
public:
    ...
    static Scalar integrate(FunctionType& func, Scalar t0, Scalar t1)
    {
        ...
        return (val0 * w0 + val1 * w1 + val2 * w1 + val3 * w2 + val4 * w2) * (t1 - t0) * 0.5;
    }
};
